        ...
        <v-flex>
            <v-container v-if="verOrdenpago==0">
                <v-toolbar  color="white">
                    <v-toolbar-title>Orden de pago por confirmar</v-toolbar-title>
                    <v-divider
                    class="mx-2"
                    inset
                    vertical
                ...
                <template>
                    <v-container class="mt-5">
                        ...
                        <v-row>
                            ...
                            transition="scale-transition" offset-y min-width="auto">
                                <template v-slot:activator="{ on, attrs }">
                                    <v-text-field v-model="fechadepago"  prepend-icon="mdi-calendar"
                                        readonly v-bind="attrs" v-on="on">
                                    </v-text-field>
                                </template>
                                <v-date-picker v-model="fechadepago" @input="menu3 = false">                                
                                </v-date-picker>
                            </v-menu>
                        </v-col>
                    
                            <v-spacer></v-spacer>
                            <v-btn class="mt-2 mr-10" color="blue darken-1" @click="confirmar(1)" >Confirmar</v-btn>
                            <v-btn class="mt-2 mr-10" color="red darken-1" @click="confirmar(0)" >Rechazar</v-btn>
    ...
    export default {
        ...
        methods:{
            ...
            listar(){
                ...
                axios.get('api/Ordendepagos/Porestado/3').then(function(response)
                {
           ...
           agregarDetalle(){
            ...
            confirmar(estado){
                ...
                {  
                    ...
                    axios.post('api/Op_confirmados/Crear',{
                        'idordendepago':me.id,
                        'fecha':me.fechadepago
